...
<form method="post">
    ...
    <!-- Food Choice -->
    <div class="mb-3">
        <label class="form-label">Food Choice</label>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="food_choice" value="Veg" required>
            <label class="form-check-label">
                Veg
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="food_choice" value="Non-Veg">
            <label class="form-check-label">
                Non-Veg
            </label>
        </div>
