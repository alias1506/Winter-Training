...
<head>
    ...
    <title>Login - My Music Stash</title>
...
<body class="bg-gray-100 h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600">
    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
            <p>New User? <a href="register.jsp" class="font-medium text-indigo-600 hover:text-indigo-500">Register</a></p>
        </div>
    </div>
    ...
    <script>
        ...
        <% if ("true".equals(request.getParameter("registered"))) { %>
            ...
            Swal.fire({
                ...
                text: 'You may now sign in with your new account.',
                confirmButtonColor: '#4f46e5',
                scrollbarPadding: false,
                heightAuto: false,
                showClass: { popup: '', backdrop: '' },
